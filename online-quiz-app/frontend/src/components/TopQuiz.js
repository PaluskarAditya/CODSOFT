...
export default function TopQuiz() {
  return (
    <div className='flex flex-col justify-center items-center'>
      ...
      <div className='grid lg:grid-cols-4 sm:grid-cols-3 gap-5 p-5 justify-center items-center'>
        ...
        <div className='flex flex-col border border-gray-200 rounded-md justify-self-center'>
          <div className='flex justify-center items-center bg-gray-100 p-5'>
