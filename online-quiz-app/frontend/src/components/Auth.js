...
export default function Auth() {
  ...
  return (
    <div className='h-screen flex justify-center items-center p-5'>
      {auth ? <div className='border justify-center items-center flex border-gray-200 rounded-md shadow-xl shadow-gray-200'>
      ...
      </div> : <div className='border justify-center items-center flex border-gray-200 rounded-md shadow-xl shadow-gray-200'>
        <div className='flex-1 rounded-l-md w-1/2 relative'>
