  ...
  return (
    <div className='h-screen -mt-[60px] flex justify-center items-center p-5'>
      {auth ? <div className='border justify-center items-center flex mt-[160px] border-gray-200 rounded-md shadow-xl shadow-gray-200'>
        <div className='flex-1 rounded-l-md w-1/2 relative resp-auth'>
        ...
        <div className='lg:1/2 flex-col flex justify-center items-center p-5 rounded-r-md gap-3'>
        ...
        <div className='w-4/4 flex-col flex justify-center items-center p-5 rounded-r-md gap-3'>
